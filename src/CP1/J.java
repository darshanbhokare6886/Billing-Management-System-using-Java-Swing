...
public class J extends JFrame {
    ...
    public J() {
        JFrame f = new JFrame("Delete Product", null);
        ...
        JLabel labelDeleteProduct = new JLabel();
        ...
        labelDeleteProduct.setFont(new java.awt.Font("Segoe UI", 1, 80)); 
        labelDeleteProduct.setForeground(new java.awt.Color(255,255,255));
        labelDeleteProduct.setText("Delete Product");
        f.add(labelDeleteProduct);
        labelDeleteProduct.setBounds(540, 30, 620, 108);
        ...
        buttonDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int productID = Integer.parseInt(jlabel0.getText());
                String deleteQuery = "DELETE FROM product_info WHERE id = " + productID;
